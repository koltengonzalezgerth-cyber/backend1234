...
it does not yet supply live market price/day-change. The app keeps using
local sample prices for now; adding a free price feed (e.g. CoinGecko for
crypto) is a natural next step, see the roadmap doc.
...
- NewsAPI's free tier is not licensed for production commercial apps at
  scale — read their terms before launch and budget for their paid plan.
